...
const tournaments = [
  { id: 1, name: "Blitz Bonanza", format: "Blitz Cricket", matches: 5, progress: 2 },
  { id: 2, name: "Power Play Challenge", format: "Power Play Pro", matches: 7, progress: 0 },
  { id: 3, name: "Classic Cup", format: "Cricket Classic", matches: 10, progress: 8 },
]
...
export default function TournamentPage() {
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-3xl font-bold text-center mb-6">Cricket Tournaments</h1>
        ...
        {tournaments.map((tournament) => (
          ...
          >
            ...
            >
              ...
              <CardContent>
                <p className="text-sm text-gray-500 mb-2">{tournament.format}</p>
                <p className="mb-2">{tournament.matches} Matches</p>
                <div className="flex items-center">
                  <Progress value={(tournament.progress / tournament.matches) * 100} className="flex-grow mr-2" />
                  <span className="text-sm">{tournament.progress}/{tournament.matches}</span>
                </div>
              </CardContent>
            </Card>
          </motion.div>
      ...
      <div className="mt-6 text-center">
        ...
        >
          {selectedTournament === null ? "Select a Tournament" : "Start Tournament"}
        </Button>
      </div>
    </div>
  )
