...
export default function ShopHub() {
	return (
		<main className='text-white space-y-4 px-3'>
			<PageHeader
				title='The Power Store'
				description='Shop for power, style, and resources to enhance your journey.'
			/>
							...
							<div className='relative h-full p-4'>
								<div className='flex flex-col h-full gap-4'>
									...
									<div className='flex-grow space-y-2'>
										...
										<p className={cn('text-sm font-medium', store.text_color)}>
											{store.description}
										</p>
									</div>
